...
class Module extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'Themys\Models\ApplicationModule', 'id', ['alias' => 'ApplicationModule']);
        $this->hasMany('id', 'Themys\Models\Composant', 'id_module', ['alias' => 'Composant']);
        $this->hasMany('id', 'Themys\Models\Developpement', 'id_module', ['alias' => 'Developpement']);
        $this->hasMany('id', 'Themys\Models\ModuleComposant', 'id_1', ['alias' => 'ModuleComposant']);
        $this->hasMany('id', 'Themys\Models\Projet', 'id_module', ['alias' => 'Projet']);
    }
